...
dat = dat.assign(util_BBR =  100*(dat.BBR_goodput)/(1000*dat.Bandwidth))
dat = dat.assign(util_CUBIC =  100*(dat.CUBIC_goodput)/(1000*dat.Bandwidth))
...
dat_sm_hm = dat[dat.Buffer==100].pivot("Bandwidth", "rtt", "util_BBR")
sns.set(font_scale=0.7)
ax = sns.heatmap(dat_sm_hm, annot=True, fmt=".1f", cmap="viridis")
ax.invert_yaxis()
ax.set_title("Link utilization for BBR, 100KB buffer")
plt.xlabel("RTT (in ms)")
plt.ylabel("Bandwidth (in Mbps)")
plt.show()

dat_sm_hm = dat[dat.Buffer==10000].pivot("Bandwidth", "rtt", "util_BBR")
sns.set(font_scale=0.7)
ax = sns.heatmap(dat_sm_hm, annot=True, fmt=".1f", cmap="viridis")
ax.invert_yaxis()
ax.set_title("Link utilization for BBR, 10MB buffer")
plt.xlabel("RTT (in ms)")
plt.ylabel("Bandwidth (in Mbps)")
plt.show()

dat_sm_hm = dat[dat.Buffer==100].pivot("Bandwidth", "rtt", "util_CUBIC")
sns.set(font_scale=0.7)
ax = sns.heatmap(dat_sm_hm, annot=True, fmt=".1f", cmap="viridis")
ax.invert_yaxis()
ax.set_title("Link utilization for CUBIC, 100KB buffer")
plt.xlabel("RTT (in ms)")
plt.ylabel("Bandwidth (in Mbps)")
plt.show()

dat_sm_hm = dat[dat.Buffer==10000].pivot("Bandwidth", "rtt", "util_CUBIC")
sns.set(font_scale=0.7)
ax = sns.heatmap(dat_sm_hm, annot=True, fmt=".1f", cmap="viridis")
ax.invert_yaxis()
ax.set_title("Link utilization for CUBIC, 10MB buffer")
plt.xlabel("RTT (in ms)")
plt.ylabel("Bandwidth (in Mbps)")
plt.show()
